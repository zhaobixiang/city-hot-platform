<template>
  <div class="home">
    ...
    <all v-show="mode === 'all'" :floor="floor" :data="floorData" @change-floor="changeFloor" />
    <standard v-show="mode === 'standard'" :floor="floor" :data="floorData" @change-floor="changeFloor" />
  </div>
</template>
