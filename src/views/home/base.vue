    ...
    <div class="home-toolbar">
      ...
      <div class="home-toolbar-right">
        ...
        <div class="home-toolbar-right-eye" @click="toggle">
          <img :src="eyeImg" />
          <div v-show="!showDialog" class="close"></div>
        </div>
      </div>
    </div>
    <div id="map"></div>
  ...
  AMapLoader.load({
    ...
    .then((AMap) => {
      ...
      const map = new AMap.Map('map', {
        ...
        layers: [AMap.createDefaultLayer(), canvasLayer],
      });
...
const addInfoBox = (rect, box) => {
  const node = $(`
    <div class="floor-marker-box1" style="left: ${rect.left - 33}px; top: ${rect.top - 35}px">
        <div class="floor-marker-box1-header">单元号: 2103</div>
        <div class="floor-marker-box1-body">
            <div>阀位: 52%</div>
            <div>回温: 37.9℃</div>
